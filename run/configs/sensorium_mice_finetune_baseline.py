...
val_mouse = 'static26872-17-20-GrayImageNet-94c6ff995dac583098847cfecd43e7b6.zip'
data_keys = [
...
log = dict(
    ...
    exp_name='sensorium_mice_finetune_baseline',
    logger_interval=10,
...
resume_from = '/data2/charon/sensorium/sensorium_mice_baseline/ckpts/exp_name=sensorium_mice_baseline-cfg=sensorium_mice_baseline-val_correlation=0.305.ckpt'
cudnn_benchmark = True

optimization = dict(
    type='epoch',
    max_iters=50,
    optimizer=dict(type='AdamW', lr=9e-4, weight_decay=0.0001),
